...
<body>
  ...
  <p>The purpose of this daily inventory is to keep track of who we are and what we are
    ...
    <section>
      <h2><em>Just for today</em> I will have faith in someone in NA who believes in me
      and wants to help me in my recovery.</h2>
      <ul>
        ${promptArray
          .map((prompt, i) => {
            if (i >= 11 && i < 17) {
    ...
    <section>
      <h2><em>Just for today</em> I will have a program; I will try to follow it to the best
      of my ability.</h2>
      <ul>
        ${promptArray
          .map((prompt, i) => {
    ...
    <section>
      <h2><em>Just for today,</em> through NA, I will try to get a better perspective on my life.</h2>
      <ul>
        ${promptArray
          .map((prompt, i) => {
            if (i >= 27 && i < 37) {
    ...
    <section>
      <h2><em>Just for today</em> I will be unafraid, my thoughts will be on my new
      associations, people who are not using and have found a new way of life.
      So long as I follow that way, I have nothing to fear.</h2>
      <ul>
        ${promptArray
          .map((prompt, i) => {
            if (i >= 37 && i < 45) {
    ...
    <section>
      <h2>Dear God, show me what I have done right and wrong today.
      Show me how I can better live and serve your will tomorrow.</h2>
      <ul>
      <li>
