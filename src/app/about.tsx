    ...
    <Screen>
      ...
      <View style={styles.body}>
        <Text style={styles.p}>
          ...
          available from <ExternalLink url="https://www.na.org">the NA website</ExternalLink> or at an{' '}
        ...
        <Text style={styles.p}>
          ...
          to a server. On the web, nothing is stored at all, but you can download a PDF of your responses on the
          last page; the mobile app can optionally keep entries on your own device.
        </Text>
        <Text style={styles.p}>
