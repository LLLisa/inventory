  ...
  return (
    <div className='content-container'>
      <p>
        ...
        will be lost. You can download a PDF of your responses and save them to your device on the
        last page. Aside from this paragraph, all of the text content in this application is
